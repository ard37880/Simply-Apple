...
Following the previous review's guideline 3.1.1 feedback, this build sells premium exclusively through App Store In-App Purchase: three auto-renewable annual subscriptions (Premium $11.99, Premium Supporter $23.99, Premium Champion $47.99) in one group. Every tier unlocks the same premium features (visual themes, diet preference alerts, and future premium features); the higher tiers are voluntary extra support, the same pay-what-you-want model other scanner apps use. The purchase UI is in the profile under "Support Simply Pure", with restore, terms, and privacy links. The previous build's external checkout link and supporter-code entry field have been removed from the app entirely; there are no links to external purchase flows and no code redemption in this build.
